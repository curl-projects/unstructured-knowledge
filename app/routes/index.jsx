...
export default function Index() {
  ...
  function generateClusterUnitCoords(data, xName, yName, labelName, clusterCoordsArray, dispersionFactor=10000){
    const clusterUnits = []

    for(let i in data){
      let obj = {}
      let cluster = data[i][labelName]
      ...
      // console.log("xGauss", xGauss.random(1)[0])
  ...
  function clusterData(e){
    ...
    const clusterUnitsArray = generateClusterUnitCoords(data, 'xDim', 'yDim', 'kmeans_labels', clusterCoordsArray)
